package com.madfeet.sirutest.tileentities;

import com.madfeet.sirutest.SiruTest;
import com.madfeet.sirutest.init.ModTileEntityTypes;
import com.madfeet.sirutest.util.helpers.NBTHelper;
...
public class QuarryTileEntity extends TileEntity implements ITickableTileEntity {
    ...
    private boolean destroyBlock(BlockPos pos, boolean dropBlock, @Nullable Entity entity) {
        ...
        if (blockState.isAir(world, pos)) {
            ...
            world.playEvent(2001, pos, Block.getStateId(blockState)); //Play the sound of the block being broken
            if(dropBlock){
    ...
    public CompoundNBT write(CompoundNBT compound) {
        compound.put("initlvalues", NBTHelper.toNBT(this));
